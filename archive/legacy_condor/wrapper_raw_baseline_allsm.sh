#!/bin/bash
# =====================================================
#  HTCondor wrapper: raw AE Baseline B × 10 seeds
#  AE trained on ALL 12 SM classes (raw features)
#
#  Comparison baseline: AUROC = (all 12 SM) vs Higgs
#  Results saved to strategies_v2/nosparse_dmodel128_seeds/raw_allsm/seed_N/
# =====================================================

set -euo pipefail

echo "[`date`] Starting raw AE baseline B (all SM) job on $(hostname)"
...
BASE_DIR=/eos/user/d/dgenoves/anomaly_pipeline/strategies_v2/nosparse_dmodel128_seeds/raw_allsm
