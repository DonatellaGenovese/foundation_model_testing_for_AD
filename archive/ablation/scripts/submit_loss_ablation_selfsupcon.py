#!/usr/bin/env python3
"""
Submit SelfSupCon loss ablation jobs to HTCondor.
...
Usage:
    python3 scripts/ablation/submit_loss_ablation_selfsupcon.py [--dry-run]
    python3 scripts/ablation/submit_loss_ablation_selfsupcon.py --experiments selfsupcon_temp010
    python3 scripts/ablation/submit_loss_ablation_selfsupcon.py --seeds 7 42
"""
...
LOG_DIR     = PROJECT_DIR / "logs/condor_logs/ablation/loss_selfsupcon"

SEEDS = [7, 42, 137, 1337, 31337]

EXPERIMENTS = [
    "ablation/loss/selfsupcon_temp005",
    "ablation/loss/selfsupcon_temp007",
    "ablation/loss/selfsupcon_temp010",
    "ablation/loss/selfsupcon_temp015",
    "ablation/loss/selfsupcon_temp020",
]
...
def main():
    parser = argparse.ArgumentParser(description="Submit SelfSupCon loss ablation jobs")
    parser.add_argument("--dry-run", action="store_true")
    parser.add_argument("--experiments", nargs="+", default=None,
                        help="Subset of experiment basenames (e.g. selfsupcon_temp010)")
